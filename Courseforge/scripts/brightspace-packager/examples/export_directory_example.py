...
def example_export_directory_usage():
    ...
    print("   - IMSCC Package: [course_name].imscc")
    print("   - D2L Export: [course_name]_d2l.zip")
    print("   - Validation Report: validation_report.md")
    ...
    print("   ✓ Save all packages to /exports/YYYYMMDD_HHMMSS/ folders")
    print("   ✓ Use generation timestamp for unique folder identification")
    print("   ✓ Automatically create /exports/ folder if it doesn't exist")
    print("   ✓ Apply structure to all package assembly phases")
...
def example_full_package_generation():
    ...
    try:
        ...
        print("Note: This is a demonstration example. Actual generation requires course content.")
...
def verify_export_requirements():
    ...
    print("   ✓ BrightspacePackager.__init__() sets up exports_path")
    print("   ✓ create_export_directory() handles automatic folder creation")
    print("   ✓ package_assembly() saves to timestamped export directory")
    print("   ✓ generate_package() coordinates full export workflow")
    print("   ✓ Both IMSCC and D2L formats generated in same directory")
...
if __name__ == "__main__":
    ...
    print("\n=== Summary ===")
    print("The brightspace-packager agent has been updated to fully implement")
    print("the export directory requirements from CLAUDE.md. All packages will")
    print("be automatically saved to timestamped directories under /exports/.")
    print("\nNext Steps:")
    print("1. Test with actual course content from firstdraft directories")
    print("2. Verify Brightspace import compatibility")
    print("3. Validate WCAG 2.2 AA accessibility compliance")
    print("4. Run OSCQR evaluation on generated packages")
