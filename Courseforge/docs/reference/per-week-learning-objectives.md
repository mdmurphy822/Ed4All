...
`scripts/rendering/generate_course.py` accepts an optional `--objectives` flag:
...
`scripts/validation/validate_page_objectives.py` walks a tree of generated HTML and
