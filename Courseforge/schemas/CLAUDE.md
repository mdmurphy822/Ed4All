...
`Courseforge/scripts/cartridge/qti_emitter.py` writes the QTI 1.2 / discussion-topic /
assignment XML and `Courseforge/scripts/cartridge/package_multifile_imscc.py` assigns the
