...
The legacy validator's placeholder regex list missed the actual SIM_201
failure modes:
...
def test_30_questions_2_stems_fails_low_stem_diversity():
    """SIM_201 smoking gun: 30 questions, 2 distinct stems. Must fail
...
def test_toc_fragment_correct_answer_fails_toc_check():
    """The exact SIM_201 failure: correct answer is raw TOC text with
