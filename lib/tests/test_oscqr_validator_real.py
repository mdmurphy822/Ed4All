...
def _build_bad_course(tmp_path: Path) -> Path:
    """Build a course that mimics the SIM_RUN_01 failure pattern."""
...
class TestOverallScoreBehavior:
    ...
    def test_sim_run_01_shape_fails_critical(self, tmp_path):
        """Simulates SIM_RUN_01 failure pattern: empty objectives, identical
