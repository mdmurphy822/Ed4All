...
(E) **answer_key webcontent presence.** When an instructor-facing
    ...
    ``Courseforge/scripts/cartridge/answer_key_emitter.py`` emits), the manifest MUST
...
* ``Courseforge/scripts/cartridge/package_multifile_imscc.py`` — the packager whose
...
class CartridgeConformanceValidator:
    ...
    # Courseforge/scripts/cartridge/answer_key_emitter).
