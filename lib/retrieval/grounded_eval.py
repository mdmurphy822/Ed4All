...
#:   sample-rag-101   sem   1.0     1.0      0.615     0.7      0.2     0.889    1.0   (2026-06-09)
#:   rdf-shacl-551-2 lex   0.5     1.0      0.5       0.6      0.2     0.667    1.0   (2026-06-10)
#:   sample-course-a  lex   0.9     1.0      0.6       0.167    0.222   1.0      0.9   (2026-06-10)
#:
...
MILESTONE_TARGETS: Dict[str, float] = {
    ...
    # spread 0.5 (rdf-shacl) .. 1.0 (sample-rag).
    "answer_rate": 0.50,
    # FLOOR == measurement. All three runs measured exactly 1.0 — sample-rag-101
    # (sem, 2026-06-09), rdf-shacl-551-2 (lex, 2026-06-10), sample-course-a (lex,
    ...
    # float-noise margin; spread 0.5 (rdf-shacl) .. 0.615 (sample-rag).
    "citation_precision": 0.45,
    # FLOOR. min measured 0.167 (sample-course-a lexical 2026-06-10), small
    # margin. The wide spread 0.167 (openstax) .. 0.7 (sample-rag) flags
    ...
    # CEILING. max measured 0.222 (sample-course-a lexical 2026-06-10), rounded
    # up; spread 0.2 (sample-rag/rdf-shacl) .. 0.222 (openstax). Lower is better.
    ...
    "refusal_recall": 0.65,
    # FLOOR. min measured 0.9 (sample-course-a lexical 2026-06-10), small
    # margin; spread 0.9 (openstax) .. 1.0 (sample-rag/rdf-shacl).
