...
def build_preflight_artifact(
    *,
    ...
    contract_paths = (
        ...
        "Trainforge/scripts/staged_window_abcd_pilot.py",
...
def main() -> int:
    ...
    if args.frozen_d_c1_manifest:
        ...
        from Trainforge.scripts.completion_cap_qualification import (
    ...
    if args.gate_d_go_artifact:
        from Trainforge.scripts.gate_d_single_row import authorize_single_row
