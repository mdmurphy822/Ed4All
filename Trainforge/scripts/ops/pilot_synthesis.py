...
``Trainforge.scripts.maintenance.pilot_report_helpers`` so the in-flight writer
inside ``synthesize_training.run_synthesis`` can share one
implementation. Behavior of this CLI is unchanged.

Example:

    python -m Trainforge.scripts.ops.pilot_synthesis \\
...
from Trainforge.scripts.maintenance.pilot_report_helpers import (  # noqa: E402
