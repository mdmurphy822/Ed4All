"""A7 — HTMLContentParser harvests the ``data-dart-opener`` role the SemantiK
adapter stamps on a promoted pedagogical-opener heading.
...
<section class="dart-section" aria-labelledby="s1" data-dart-block-id="s1"
...
<section class="dart-section" id="p2" data-dart-block-id="p2"
         data-dart-source="synthesized">
