...
def test_5_every_block_type_has_validator_matrix_entry() -> None:
    ...
    # Defence-in-depth: BLOCK_TYPES is exactly 28 values per
    # ``Courseforge/scripts/blocks.py:77`` (16 Phase-2 + 5 Wave-2
    # block-variety + 3 Issue-I6 instruction-palette-v2 + 4 IB5
    # framework-aligned pedagogical additions) and the W3.C plan §C2.
    assert len(BLOCK_TYPES) == 28, (
        f"BLOCK_TYPES drift: expected 28 canonical block types, got "
