...
def test_5_every_block_type_has_validator_matrix_entry() -> None:
    ...
    # Defence-in-depth: BLOCK_TYPES is exactly 16 values per
    # ``Courseforge/scripts/blocks.py:77-96`` and the W3.C plan §C2.
    assert len(BLOCK_TYPES) == 16, (
        f"BLOCK_TYPES drift: expected 16 canonical block types, got "
