...
_HEADING_BLOCKLIST_TOKENS = frozenset([
    ...
    # leaked into week titles on the real SIM_201 run.
...
# Catches "Hung-Nghiep Tran Atsuhiro Takasu" / "Cover design by a textbook author"
...
# parenthetical nicknames ("A.W. (Tony) sample-corpus"). Token may be all-caps when
...
# textbook like demo's, they're pedagogically meaningful — real examples
...
def _is_low_signal_heading(heading: str) -> bool:
    ...
    #       ("Cover design by a textbook author" is a byline even at two authors).
    ...
    #       Catches bare 2-name bylines ("a textbook author") without false-
    ...
    if word_count >= 2:
        ...
        if tokens_for_name_check and len(tokens_for_name_check) >= 1:
            ...
            if all_name_like:
                ...
                #     demo" without tripping "European Union Policy").
...
# NOT a bare author byline ("a textbook author", "John Smith"). Kept intentionally
...
# demo-style: "Review question 2.3.", "Exercise 5.1.", "Self-check questions",
# "Activity 3".
