...
#
#   scripts/datasets/densify_targets.py::_heading_sanity_demote
...
"$PY" scripts/datasets/densify_targets.py \
...
echo "[v8] 05 split" >&2
"$PY" scripts/datasets/split_chunks.py \
...
CLASSIFIER=models/classifier_v5/final \
    scripts/eval/eval_v7_family.sh \
