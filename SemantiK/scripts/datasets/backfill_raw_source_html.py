...
Usage:
    ...
    python scripts/datasets/backfill_raw_source_html.py --dry-run

    # backfill arxiv from local cache (fast, no network)
    python scripts/datasets/backfill_raw_source_html.py --source arxiv

    # backfill wikipedia (slow — ~70 min for 2K pairs at workers=1)
    python scripts/datasets/backfill_raw_source_html.py --source wikipedia
"""
