...
``scripts/datasets/build_semantic_preservation_dataset.py`` — sentence
...
Usage:
    CUDA_VISIBLE_DEVICES="" .venv/bin/python scripts/calibration/calibrate_theta.py \
        --n 80 --write-config
"""
...
def write_config(
    ...
    lines = [
        ...
        "# scripts/calibration/calibrate_theta.py (Plan 12 A3) — see the calibration block",
