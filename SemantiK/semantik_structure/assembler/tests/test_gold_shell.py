...
from semantik_structure.assembler.gold_shell_markup import (
    _wrap_semantic_class,
    collect_doc_ids,
)
from semantik_structure.assembler.api import assemble_document, AssemblerConfig
from semantik_structure.assembler.semantic_catalog import label_for
...
from semantik_structure.assembler.shell import (  # noqa: E402
    DOC_CLOSE,
    DOC_OPEN,
    TITLE_SLOT_SENTINEL,
    build_shell,
)
from semantik_structure.assembler.pass_9c import _splice_missing_title  # noqa: E402
from semantik_structure.gates.hard_document import _check_html5_wellformed  # noqa: E402
...
from semantik_structure.assembler.pass_9a import run_pass_9a  # noqa: E402
from semantik_structure.gates.hard_document import _check_heading_hierarchy  # noqa: E402
...
from semantik_structure.assembler.gold_shell_markup import (  # noqa: E402
    _ABSORB_MAX_RUN,
    compute_absorption_runs,
)
from semantik_structure.assembler.shell import resolve_gold_absorb_mode  # noqa: E402
...
def test_gold_absorb_deprecation_warns_once_when_engaged(monkeypatch, caplog):
    ...
    import semantik_structure.assembler.shell as shell_mod
...
from semantik_structure.pedagogical_units import is_passthrough_region  # noqa: E402
from semantik_structure.assembler.shell import (  # noqa: E402
    resolve_narrow_table_absorb_mode,
)
from semantik_structure.qwen_specialists.block_resegment import (  # noqa: E402
    _is_passthrough,
)
