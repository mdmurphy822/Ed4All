...
from semantik_structure.assembler.shell import DOC_OPEN
from semantik_structure.assembler.wcag22_css import WCAG22_CSS
from semantik_structure.assembler import gold_shell_markup
...
def test_assembler_output_unchanged():
    ...
    import semantik_structure.assembler.api as api_mod
    import semantik_structure.assembler.fallbacks as fallbacks_mod
    import semantik_structure.assembler.pass_9a as pass_9a_mod
