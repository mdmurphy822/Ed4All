...
These tests import ``semantik_structure.qwen_specialists.*``. The package root
is ``SemantiK/`` (two levels above this file's ``semantik_structure/`` parent),
...
# .../SemantiK/semantik_structure/qwen_specialists/tests/conftest.py
#   parents[0]=tests parents[1]=qwen_specialists parents[2]=semantik_structure
