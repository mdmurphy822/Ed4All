...
def test_menu_injected_when_flag_on(monkeypatch):
    from semantik_structure.assembler.semantic_catalog import valid_components
...
def test_prompt_says_always_assign(monkeypatch):
    ...
    monkeypatch.setenv("SEMANTIK_SEMANTIC_CLASS", "1")
    from semantik_structure.qwen_specialists import reviewer_prompt as rp
...
from semantik_structure.qwen_specialists.reviewer_prompt import _COUNCIL_TOPK_DIRECTIVE  # noqa: E402
