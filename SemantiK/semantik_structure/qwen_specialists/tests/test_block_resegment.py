...
def test_dropping_op_fails_closed_to_input(monkeypatch):
    ...
    import semantik_structure.qwen_specialists.block_resegment as mod
...
def test_detect_caps_at_absorb_max_run(unit_regroup_on):
    ...
    from semantik_structure.pedagogical_units import ABSORB_MAX_RUN
...
def test_unknown_css_class_no_fabricated_component():
    ...
    for."""
    from semantik_structure.qwen_specialists.block_resegment import _merged_region
...
def test_rpart_and_token_conservation_hold_cross_kind(unit_regroup_on):
    ...
    from semantik_structure.qwen_specialists.reviewer import assert_token_conservation
...
def test_resegment_digest_carries_role_top_k_when_stamped():
    from semantik_structure.qwen_specialists.block_resegment_prompt import _region_obj
    from semantik_structure.structure_graph import Region as _R
