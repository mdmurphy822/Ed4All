...
def test_cluster_signals_phantom_run_no_content():
    ...
    from semantik_structure.qwen_specialists.reviewer import compute_cluster_signals
...
def test_full_window_op_list_not_truncated(monkeypatch):
    ...
    from semantik_structure.qwen_specialists.reviewer import _PER_MEMBER_OP_MAX_TOKENS
...
def test_window_fail_soft_keeps_deterministic(monkeypatch):
    ...
    from semantik_structure.qwen_specialists.reviewer import _build_windows
...
def test_flag_off_single_block_path_byte_stable(monkeypatch):
    ...
    import semantik_structure.qwen_specialists.reviewer as rv
...
def test_verdict_dataclass_frozen():
    ...
    from semantik_structure.qwen_specialists.reviewer import FlaggedBlock, VerifierVerdict
...
def test_flagged_block_proposed_regroup_run_optional():
    from semantik_structure.qwen_specialists.reviewer import FlaggedBlock
...
def test_window_capture_meta_margin_stats():
    from semantik_structure.qwen_specialists.reviewer import _build_window_capture_meta
