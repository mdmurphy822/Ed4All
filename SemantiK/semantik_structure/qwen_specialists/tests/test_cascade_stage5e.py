...
from semantik_structure import cascade  # noqa: E402,F401  (import-loads the module)
...
def test_in_box_table_routes_to_table_adapter(monkeypatch):
    ...
    from semantik_structure.qwen_specialists.routing import adapter_for, AdapterID
