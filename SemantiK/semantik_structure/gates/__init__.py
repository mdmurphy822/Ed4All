...
def __getattr__(name: str):
    ...
    time because :mod:`semantik_structure.soft_reranker.region` imports
    :mod:`semantik_structure.gates.text_preserve` (a sibling submodule) —
    ...
    raise AttributeError(f"module 'semantik_structure.gates' has no attribute {name!r}")
