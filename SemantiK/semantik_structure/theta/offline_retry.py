...
:func:`semantik_structure.theta.exits.decide_exit` to stamp.

The orchestrator owns NONE of the cascade machinery — the caller
(``semantik_structure/cascade.py:run_full_cascade`` or any future
...
def maybe_offline_retry(
    ...
    *,
    ...
    ThetaReport
        ...
        :func:`semantik_structure.theta.exits.decide_exit`. When no retry
