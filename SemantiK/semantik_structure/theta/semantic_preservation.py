...
(:mod:`semantik_structure.theta._module_state` via ``paths.resolve_model``,
...
``stub_v1`` fallback path in :mod:`semantik_structure.theta.evaluator` does
...
def score(
    ...
    *,
    ...
    :mod:`semantik_structure.theta.evaluator`.
    """
