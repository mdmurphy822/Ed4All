...
# Direct module import (not via ``from semantik_structure.gates``) so that
...
from semantik_structure.gates.text_preserve import text_preservation_ratio  # noqa: E501
