...
math out of :func:`semantik_structure.council.merge_or_split._column_ids_for_page`
...
def resolve_column_extract_mode() -> bool:
    ...
    **Default OFF** (unset / blank / falsey / garbage -> off; byte-identical to
    ...
    :func:`semantik_structure.extract_shared._pdfplumber_page`). A truthy value
...
def resolve_column_order_mode() -> bool:
    ...
    mirroring :func:`semantik_structure.structure_graph.resolve_reading_order_fix`
...
def column_edges_from_lines(
    ...
    *,
    ...
    :func:`semantik_structure.extract_shared._assemble_text_blocks_columnaware`
