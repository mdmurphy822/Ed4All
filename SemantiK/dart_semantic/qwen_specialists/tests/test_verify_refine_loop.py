...
``dart_semantic.cascade`` imports ``dart_semantic.validate`` which pulls
...
from dart_semantic.cascade import _build_region_provenance, _verify_refine_loop  # noqa: E402
from dart_semantic.qwen_specialists import reviewer as rv  # noqa: E402
...
def test_unflagged_regions_byte_identical_across_rounds(monkeypatch):
    ...
    to the prior round."""
    from dart_semantic.assembler.verify_digest import slice_region_html
