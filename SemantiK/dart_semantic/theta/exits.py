...
:func:`dart_semantic.theta.offline_retry.maybe_offline_retry`. The
...
``OFFLINE_LANE_UNAVAILABLE_V1``) stay in :mod:`dart_semantic.theta.types`
...
class StageThirteenStubRequired(RuntimeError):
    ...
    .. deprecated:: Stage 13 v1.1
        ...
        :func:`dart_semantic.theta.offline_retry.maybe_offline_retry`.
        ...
        if report.lane == "fast":
            ...
            raise StageThirteenStubRequired(
                ...
                reason=(
                    ...
                    "Wire dart_semantic.theta.offline_retry.maybe_offline_retry "
