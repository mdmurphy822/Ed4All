...
from dart_semantic import figure_captioner, image_extract
from dart_semantic.figure_captioner import (
    FigureCaptionError,
    caption_figure_regions,
)
from dart_semantic.image_extract import (
    FigureRenderError,
...
def test_genuine_rasterizer_failure_still_honors_fail_soft():
    ...
    import dart_semantic.image_extract as ie
