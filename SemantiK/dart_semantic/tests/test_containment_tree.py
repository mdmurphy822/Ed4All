...
from dart_semantic.assembler.pass_9a import _group_regions_into_sections
from dart_semantic.containment import (
    ContainmentTree,
    _assert_tree_cover,
    _unit_runs,
...
def test_tree_cover_every_node_once_and_identity_preorder():
    ...
    tree = build_containment_tree(regions, [_fb() for _ in regions], region_html=html)
    from dart_semantic.containment import _preorder
