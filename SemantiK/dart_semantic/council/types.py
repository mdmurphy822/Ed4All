...
:class:`CouncilState`. See ``dart_semantic/council/cross_reranker.py``
...
# shape in `dart_semantic.region_detection` (kind, bbox, pages,
...
class RoutingDecision:
    ...
    :func:`~dart_semantic.council.cross_reranker.arbitrate`, which in
    v1 is ``table_candidates + math_candidates`` (see
    :func:`~dart_semantic.council.orchestrator.run_council`). It is
