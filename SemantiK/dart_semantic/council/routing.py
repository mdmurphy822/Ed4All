...
:class:`~dart_semantic.region_detection.MathCandidate` regions emitted
by Stage 2's :func:`~dart_semantic.region_detection.detect_math_region_candidates`.
...
:attr:`~dart_semantic.region_detection.MathCandidate.glyph_density_features`
as a deterministic stand-in detector.

Per architecture.md §3.1: pass distributions (top-k + confidences), not
argmax. The orchestrator (``dart_semantic.council.orchestrator``) walks
