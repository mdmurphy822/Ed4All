...
:func:`dart_semantic.council.orchestrator.run_council` and emits one
...
class MathThresholds:
    ...
    :func:`~dart_semantic.region_detection.detect_math_region_candidates`,
...
def confirm_table_candidates(
    ...
    *,
    ...
    bboxes — see :func:`dart_semantic.glm_ocr_enrich.enrich_via_council_gate`).
