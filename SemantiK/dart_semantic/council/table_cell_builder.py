...
Bridges Stage 2's :class:`~dart_semantic.region_detection.TableCandidate`
output to the cell-level input contract that
:mod:`dart_semantic.council.table_specialist` expects:
...
``data.build_table_specialist_data``:
    ...
    :mod:`dart_semantic.council.table_specialist` was trained against
