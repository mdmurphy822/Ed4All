...
The catalog (``dart_semantic/config/semantic_components.yaml``) is DATA ONLY —
...
_CATALOG_PATH = (
    Path(dart_semantic.__file__).parent / "config" / "semantic_components.yaml"
)
