...
Usage::
    ...
    python data/builders/build_gap_fill_qwen_data.py                      # full
    python data/builders/build_gap_fill_qwen_data.py --max-pairs 30 \
...
def main() -> None:
    ...
    coverage = {
        ...
        "notes": {
            ...
            "split_function": (
                "data.common._splits.stable_split_for_id, train_frac=0.80, "
