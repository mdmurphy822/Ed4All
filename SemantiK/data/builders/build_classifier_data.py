...
This module is superseded by `data/builders/build_classifier_data_v2.py`, which
...
def main() -> None:
    import sys
    print(
        "WARNING: data/builders/build_classifier_data.py is DEPRECATED.\n"
        "         Use data/builders/build_classifier_data_v2.py, which emits the\n"
