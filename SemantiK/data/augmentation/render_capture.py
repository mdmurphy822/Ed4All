...
proposed replacement for the fuzzy text aligner (``data/alignment/structure_align.py`` /
...
from data.builders.build_structure_data import OUTER_TAG_ALLOW_NESTED as _OUTER_ALLOW  # noqa: E402
