...
consumers can ingest PMC unchanged:
  ...
  * the Qwen table adapter builder (``data/builders/build_table_qwen_multi.py``) — parses
    the HTML5 ``<table>`` via lxml and reuses the ar5iv grid/role/target code.
  * the BERT cell-role builder (``data/builders/build_table_specialist_data.py``) — feeds
