"""Evaluation set generation for LibV2.
...
from .harness import EvalQuery, EvalSet
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python -m LibV2.tools.libv2.evaluation.generator <course_dir> [num_queries]")
        sys.exit(1)
