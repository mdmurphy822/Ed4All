...
DEFAULT_BOOST_WEIGHTS: Dict[str, float] = {
    ...
    # The conservative default keeps this secondary signal from dominating
    # lexical relevance.
    ...
    # and reward chunks whose chunk_type matches.
...
RETRIEVAL_METHOD_PRESETS: Dict[str, Dict[str, Any]] = {
    ...
    "bm25+intent": {
        # BM25 plus the chunk-type intent prior only.
        "metadata_scoring": True,
    ...
    "bm25+tag": {
        # BM25 plus IDF-weighted tag overlap for isolated signal evaluation.
        "metadata_scoring": True,
        "use_concept_graph_boost": False,
        "use_lo_match_boost": False,
        "use_targets_concept_boost": False,
