...
Usage::
    ...
    python -m LibV2.tools.libv2.scripts.ops.backfill_legacy_chunks
    ...
    python -m LibV2.tools.libv2.scripts.ops.backfill_legacy_chunks --dry-run
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        ...
        description=(
            ...
            "for legacy or partially migrated LibV2 courses."
        ),
