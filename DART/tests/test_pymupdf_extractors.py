...
class TestExtractMetadataPymupdf:
    def test_normalises_typical_metadata(self):
        doc = _FakeFitzDoc(
            pages=[],
            metadata={
                "title": "  sample-corpus Teaching Digital Age  ",
                "author": "A. W. sample-corpus",
        ...
        assert meta["title"] == "sample-corpus Teaching Digital Age"
        assert meta["author"] == "A. W. sample-corpus"
