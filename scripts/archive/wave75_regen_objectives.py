...
An external review of a knowledge package flagged 312
...
Requires ``--archive-dir`` (the LibV2 course archive) and
``--objectives-source`` (the Courseforge synthesized_objectives.json)
to point at the course being regenerated.
"""
