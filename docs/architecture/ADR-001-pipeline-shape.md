...
- The durable v4 shape is documented in
  [`chunk-schema-v4.md`](chunk-schema-v4.md) and enforced by its schemas and
  tests. Future shape changes require an explicit compatibility decision and
  one coordinated version bump per release train.
